...
import data
from tokenization import TyDiXLMTokenizer

#import tensorflow.contrib as tf_contrib
from transformers import RobertaTokenizer, TFXLMRobertaModel

#tokenizer = TyDiXLMTokenizer(vocab_file='modified_xlm_large_new.model')
#vocab_size = tokenizer.vocab_size()
#What is added is the pretraiend-loaded model
